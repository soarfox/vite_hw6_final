...
# 部署到 https://soarfox.github.io/vite_hw6_final
# 已將下方master改成main, 替換成自己的帳號與repository網址, 記得要把預設的<>符號都拿掉
# git push -f git@github.com:soarfox/vite_hw6_final.git main:gh-pages
...
git push -f https://github.com/soarfox/vite_hw6_final.git main:gh-pages
